...
<head>
	...
	<link href="/Public/Style/Application/styles.css" rel="stylesheet">
	<link href="/Public/Style/Application/animation.css" rel="stylesheet">
	<!-- 返回顶部调用 begin -->
	<link href="/Public/Style/Application/lrtk.css" rel="stylesheet"/>
	<script type="text/javascript" src="/Public/Script/Application/jquery.js"></script>
	<script type="text/javascript" src="/Public/Script/Application/js.js"></script>
	<!-- 返回顶部调用 end-->
	<!--[if lt IE 9]>
	<script src="/Public/Script/Application/modernizr.js"></script>
	<![endif]-->
</head>
<body>
<header>
	<nav id="nav">
		...
		<script src="/Public/Script/Application/silder.js"></script>
		<!--获取当前页导航 高亮显示标题-->
	</nav>
</header>
<!--header end-->
